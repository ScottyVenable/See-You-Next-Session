...
export const SPEAKERS = ['PATIENT', 'THERAPIST', 'NARRATOR', 'SYSTEM'] as const;
...
export const DOCUMENTATION: Record<string, { signature: string; description: string; example?: string }> = {
    // Directives
    '@if': {
